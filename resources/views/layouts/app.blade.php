                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown notifications-menu">
                            <a href="#" class="waves-effect waves-light dropdown-toggle btn-primary-light"
                                ...
                                <i class="icon-Notification"><span class="path1"></span><span
                                        class="path2"></span></i>
                            </a>
                        ...
                        <li class="dropdown notifications-menu">
                            <a href="#" class="waves-effect waves-light dropdown-toggle btn-primary-light" data-bs-toggle="dropdown" title="User Settings">
                                <i class="ti-user"></i>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end shadow-sm mt-2 rounded animated fadeIn">
                                <li class="header p-3 text-center border-bottom">
                                ...
                                <li>
                                    ...
                                    <ul class="menu p-2">
                                        <li class="d-flex align-items-center">
                                            <a href="{{ url('logout') }}" class="d-flex align-items-center text-danger text-decoration-none" data-bs-toggle="tooltip" title="Logout">
                                                <i class="ti-power-off me-2 fs-5"></i> Logout
                                            </a>
                                        </li>
                                    </ul>
                                </li>
            ...
            <section class="sidebar position-relative">
                <div class="user-profile bb-1 px-20 py-10">
                    ...
                    {{-- <ul class="list-inline profile-setting mt-20 mb-0 d-flex justify-content-center gap-3">
                        <li><a href="{{ url('logout') }}" data-bs-toggle="tooltip" title="Logout"><i
