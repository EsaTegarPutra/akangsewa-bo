            ...
            <div class="col-lg-12">
                <div class="box">
                    <div class="box-header with-border">
                        <h4 class="box-title">Edit Product Description</h4>
                    </div>
                    <!-- /.box-header -->
                    <form id="fSubmit" class="form" action="{{ url('product/description/update/' . $description['id']) }}" method="post">
                        {{ csrf_field() }}
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select id="productId" name="productId" class="form-select" value="">
                                                    <option value="" disabled></option>
                                                    @foreach ($products as $product)
                                                        <option value="{{ $product['id'] }}"
                                                            {{ $product['id'] == $description['productId'] ? 'selected' : '' }}>
                                                            {{ $product['productName'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" name="descriptionValue" id="descriptionValue"
                                            value="{{ $description['descriptionValue'] }}"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
