        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="box">
                    ...
                    <!-- /.box-header -->
                    <form id="fSubmit" class="form" action="{{ url('masterData/category/update/' . $category['id']) }}"
                        method="post">
                        {{ csrf_field() }}
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="status" name="status" class="form-select">
                                            ...
                                            <option value="true" {{ $category['status'] == true ? 'selected' : '' }}>
                                                Enable</option>
                                            <option value="false" {{ $category['status'] == false ? 'selected' : '' }}>
                                                Disable</option>
                                        </select>
                                    </div>
                                </div>
